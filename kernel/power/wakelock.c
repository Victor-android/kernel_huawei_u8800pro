...
#ifdef CONFIG_HUAWEI_KERNEL
/* function: initialize sys_sync work struct */ 
...
/* function: schedule sys_sync workqueue */ 
...
/* function: suspend sys_sync timer handler  */ 
...
/* function: waiting for sys_sync to complete  */ 
...
/* initialize sys_sync completion and create sys_sync workqueue */ 
#ifdef CONFIG_HUAWEI_KERNEL
...
/* add error handler when initializing sys_sync workqueue */ 
#ifdef CONFIG_HUAWEI_KERNEL
...
/* destroy the sys_sync workqueue when exit */ 
#ifdef CONFIG_HUAWEI_KERNEL
	destroy_workqueue(suspend_sys_sync_work_queue);
#endif
	platform_driver_unregister(&power_driver);
