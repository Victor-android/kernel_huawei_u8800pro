...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 1920000, PLL_2, 3, 0, UINT_MAX, 1400, VDD_RAW(1400), &pll2_tbl[10]},
	{ 1, 1996800, PLL_2, 3, 0, UINT_MAX, 1400, VDD_RAW(1400), &pll2_tbl[11]},
	{ 1, 2073600, PLL_2, 3, 0, UINT_MAX, 1400, VDD_RAW(1450), &pll2_tbl[12]},
	{ 1, 2112000, PLL_2, 3, 0, UINT_MAX, 1400, VDD_RAW(1450), &pll2_tbl[13]},
	{ 0 }
};
