...
/* rx volume from 0dB to 4dB */
/* rx volume from -2dB to 0dB */
...
/*< U8800-51 Ver.D device begin */
/* parallel inductance */
static struct adie_codec_action_unit iearpiece_48KHz_osr256_actions_u8800_51_ver_d[] =
	HANDSET_RX_48000_OSR_256_U8800_51_VER_D;

static struct adie_codec_hwsetting_entry iearpiece_settings_u8800_51_ver_d[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = iearpiece_48KHz_osr256_actions_u8800_51_ver_d,
		.action_sz = ARRAY_SIZE(iearpiece_48KHz_osr256_actions_u8800_51_ver_d),
	}
};

static struct adie_codec_dev_profile iearpiece_profile_u8800_51_ver_d = {
	.path_type = ADIE_CODEC_RX,
	.settings = iearpiece_settings_u8800_51_ver_d,
	.setting_sz = ARRAY_SIZE(iearpiece_settings_u8800_51_ver_d),
};

/* rx volume from 0dB to 6dB */
/* 2011.5.27 rx vol from -2dB to 0dB */
static struct snddev_icodec_data snddev_iearpiece_data_u8800_51_ver_d = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "handset_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_SPKR,
	.profile = &iearpiece_profile_u8800_51_ver_d,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_iearpiece_device_u8800_51_ver_d = {
	.name = "snddev_icodec",
	.id = 0,
	.dev = { .platform_data = &snddev_iearpiece_data_u8800_51_ver_d },
};
/* U8800-51 Ver.D device end >*/
...
/* HAC WITHGPIO handset */
/* When hac device enable, pull GPIO as swith of inductance at the same time */
static struct adie_codec_action_unit iearpiece_hac_withGPIO_48KHz_osr256_actions[] =
	HANDSET_HAC_WITHGPIO_RX_48000_OSR_256;

static struct adie_codec_hwsetting_entry iearpiece_hac_withGPIO_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = iearpiece_hac_withGPIO_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(iearpiece_hac_withGPIO_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile iearpiece_hac_withGPIO_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = iearpiece_hac_withGPIO_settings,
	.setting_sz = ARRAY_SIZE(iearpiece_hac_withGPIO_settings),
};

static struct snddev_icodec_data snddev_iearpiece_hac_withGPIO_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "handset_hac_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_HAC_SPKR,
	.profile = &iearpiece_hac_withGPIO_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_iearpiece_hac_withGPIO_device = {
	.name = "snddev_icodec",
	.id = 35,
	.dev = { .platform_data = &snddev_iearpiece_hac_withGPIO_data },
};
...
/* As huawei devices are added independently, delete msm_ihs_music_stereo_rx_device */
...
/* max rx volume from 6dB to 12dB */
/* max rx volume from 8dB to 6dB */
/* max rx volume from 12dB to 8dB */
/* max rx volume from 2dB to 12dB */
...
#ifdef CONFIG_HUAWEI_KERNEL
/*< U8820 device begin */
static struct adie_codec_action_unit ispeaker_stereo_rx_48KHz_osr256_actions_u8820[] =
   SPEAKER_STEREO_RX_48000_OSR_256_U8820;

static struct adie_codec_hwsetting_entry ispeaker_stereo_rx_settings_u8820[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ispeaker_stereo_rx_48KHz_osr256_actions_u8820,
		.action_sz = ARRAY_SIZE(ispeaker_stereo_rx_48KHz_osr256_actions_u8820),
	}
};

static struct adie_codec_dev_profile ispeaker_stereo_rx_profile_u8820 = {
	.path_type = ADIE_CODEC_RX,
	.settings = ispeaker_stereo_rx_settings_u8820,
	.setting_sz = ARRAY_SIZE(ispeaker_stereo_rx_settings_u8820),
};

static struct snddev_icodec_data snddev_ispeaker_stereo_rx_data_u8820 = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "speaker_stereo_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_STEREO, //8,
	.profile = &ispeaker_stereo_rx_profile_u8820,
	.channel_mode = 2,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_ispeaker_stereo_rx_device_u8820 = {
	.name = "snddev_icodec",
	.id = 31,
	.dev = { .platform_data = &snddev_ispeaker_stereo_rx_data_u8820 },
...
/* change rx volume from -17db to -30db */
static struct snddev_icodec_data snddev_ispeaker_ptt_rx_data = {
	...
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
	.pamp_on = &msm_snddev_poweramp_4qchat_on,
	.pamp_off = &msm_snddev_poweramp_off,
	.max_voice_rx_vol[VOC_NB_INDEX] = 200, 
	.min_voice_rx_vol[VOC_NB_INDEX] = -3000, 
	.max_voice_rx_vol[VOC_WB_INDEX] = 200, 
	.min_voice_rx_vol[VOC_WB_INDEX] = -3000  
};
...
#ifdef CONFIG_HUAWEI_KERNEL
static struct adie_codec_action_unit iearpiece_ptt_48KHz_osr256_actions[] =
	HANDSET_PTT_RX_48000_OSR_256;

static struct adie_codec_hwsetting_entry iearpiece_ptt_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = iearpiece_ptt_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(iearpiece_ptt_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile iearpiece_ptt_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = iearpiece_ptt_settings,
	.setting_sz = ARRAY_SIZE(iearpiece_ptt_settings),
};

static struct snddev_icodec_data snddev_iearpiece_ptt_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "handset_ptt_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_SPKR_PTT,
	.profile = &iearpiece_ptt_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_iearpiece_ptt_device = {
	.name = "snddev_icodec",
	.id = 249,
	.dev = { .platform_data = &snddev_iearpiece_ptt_data },
};


/* idual_mic ptt */
static struct adie_codec_action_unit idual_mic_bs_8KHz_osr256_actions_ptt[] =
	MIC1_LEFT_AUX_IN_RIGHT_8000_OSR_256_PTT;

static struct adie_codec_hwsetting_entry idual_mic_broadside_settings_ptt[] = {
	{
		.freq_plan = 8000,
		.osr = 256,
		.actions = idual_mic_bs_8KHz_osr256_actions_ptt,
		.action_sz = ARRAY_SIZE(idual_mic_bs_8KHz_osr256_actions_ptt),
...
static struct adie_codec_dev_profile idual_mic_broadside_profile_ptt = {
	.path_type = ADIE_CODEC_TX,
	.settings = idual_mic_broadside_settings_ptt,
	.setting_sz = ARRAY_SIZE(idual_mic_broadside_settings_ptt),
};

static enum hsed_controller idual_mic_broadside_pmctl_id_ptt[] = {
	PM_HSED_CONTROLLER_0, PM_HSED_CONTROLLER_2
};

static struct snddev_icodec_data snddev_idual_mic_broadside_data_ptt = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "handset_dual_mic_broadside_ptt_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_SPKR_PTT_MIC,
	.profile = &idual_mic_broadside_profile_ptt,
	.channel_mode = 2,
	.default_sample_rate = 48000,
	.pmctl_id = idual_mic_broadside_pmctl_id_ptt,
	.pmctl_id_sz = ARRAY_SIZE(idual_mic_broadside_pmctl_id_ptt),
	.pamp_on = NULL,
	.pamp_off = NULL,
};

static struct platform_device msm_idual_mic_broadside_ptt_device = {
	.name = "snddev_icodec",
	.id = 247,
	.dev = { .platform_data = &snddev_idual_mic_broadside_data_ptt },
};


/* hs ptt */
static struct adie_codec_action_unit ihs_mono_tx_8KHz_osr256_actions_ptt[] =
	HEADSET_MONO_TX_8000_OSR_256_PTT;

static struct adie_codec_action_unit ihs_mono_tx_16KHz_osr256_actions_ptt[] =
	HEADSET_MONO_TX_16000_OSR_256_PTT;

static struct adie_codec_action_unit ihs_mono_tx_48KHz_osr256_actions_ptt[] =
	HEADSET_MONO_TX_48000_OSR_256_PTT;

static struct adie_codec_hwsetting_entry ihs_mono_tx_settings_ptt[] = {
	{
		.freq_plan = 8000,
		.osr = 256,
		.actions = ihs_mono_tx_8KHz_osr256_actions_ptt,
		.action_sz = ARRAY_SIZE(ihs_mono_tx_8KHz_osr256_actions_ptt),
	},
	{
		.freq_plan = 16000,
		.osr = 256,
		.actions = ihs_mono_tx_16KHz_osr256_actions_ptt,
		.action_sz = ARRAY_SIZE(ihs_mono_tx_16KHz_osr256_actions_ptt),
	},
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ihs_mono_tx_48KHz_osr256_actions_ptt,
		.action_sz = ARRAY_SIZE(ihs_mono_tx_48KHz_osr256_actions_ptt),
	}
};

static struct adie_codec_dev_profile ihs_mono_tx_profile_ptt = {
	.path_type = ADIE_CODEC_TX,
	.settings = ihs_mono_tx_settings_ptt,
	.setting_sz = ARRAY_SIZE(ihs_mono_tx_settings_ptt),
};

static struct snddev_icodec_data snddev_ihs_mono_tx_data_ptt = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "headset_ptt_mono_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HEADSET_PTT_MIC,
	.profile = &ihs_mono_tx_profile_ptt,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_ihs_mono_tx_device_ptt = {
	.name = "snddev_icodec",
	.id = 246,
	.dev = { .platform_data = &snddev_ihs_mono_tx_data_ptt },
};

static struct adie_codec_action_unit iearpiece_music_48KHz_osr256_actions_u8820[] =
	HANDSET_MUSIC_RX_48000_OSR_256_U8820;

static struct adie_codec_hwsetting_entry iearpiece_music_settings_u8820[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = iearpiece_music_48KHz_osr256_actions_u8820,
		.action_sz = ARRAY_SIZE(iearpiece_music_48KHz_osr256_actions_u8820),
	}
};

static struct adie_codec_dev_profile iearpiece_music_profile_u8820 = {
	.path_type = ADIE_CODEC_RX,
	.settings = iearpiece_music_settings_u8820,
	.setting_sz = ARRAY_SIZE(iearpiece_music_settings_u8820),
};


static struct snddev_icodec_data snddev_iearpiece_music_data_u8820 = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "handset_music_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_SPKR_MUSIC,
	.profile = &iearpiece_music_profile_u8820,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_iearpiece_music_device_u8820 = {
	.name = "snddev_icodec",
	.id = 245,
	.dev = { .platform_data = &snddev_iearpiece_music_data_u8820 },
};

static struct adie_codec_action_unit ihs_ptt_stereo_rx_48KHz_osr256_actions[] =
	HEADSET_STEREO_RX_CAPLESS_48000_OSR_256_PTT;

static struct adie_codec_hwsetting_entry ihs_ptt_stereo_rx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ihs_ptt_stereo_rx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ihs_ptt_stereo_rx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ihs_ptt_stereo_rx_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = ihs_ptt_stereo_rx_settings,
	.setting_sz = ARRAY_SIZE(ihs_ptt_stereo_rx_settings),
};

static struct snddev_icodec_data snddev_ihs_ptt_stereo_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "headset_ptt_stereo_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HEADSET_SPKR_STEREO_PTT,
	.profile = &ihs_ptt_stereo_rx_profile,
	.channel_mode = 2,
	.default_sample_rate = 48000,
	.pamp_on = msm_snddev_hsed_voltage_on,
	.pamp_off = msm_snddev_hsed_voltage_off,
...
static struct platform_device msm_ihs_ptt_stereo_rx_device = {
	.name = "snddev_icodec",
	.id = 248,
	.dev = { .platform_data = &snddev_ihs_ptt_stereo_rx_data },
};
...
#if 0
#ifdef CONFIG_HUAWEI_KERNEL
static struct adie_codec_action_unit ispeaker_music_stereo_rx_48KHz_osr256_actions_u8820[] =
   SPEAKER_MUSIC_STEREO_RX_48000_OSR_256_U8820; 

static struct adie_codec_hwsetting_entry ispeaker_music_stereo_rx_settings_u8820[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ispeaker_music_stereo_rx_48KHz_osr256_actions_u8820,
		.action_sz = ARRAY_SIZE(ispeaker_music_stereo_rx_48KHz_osr256_actions_u8820),
	}
};

static struct adie_codec_dev_profile ispeaker_music_stereo_rx_profile_u8820 = {
	.path_type = ADIE_CODEC_RX,
	.settings = ispeaker_music_stereo_rx_settings_u8820,
	.setting_sz = ARRAY_SIZE(ispeaker_music_stereo_rx_settings_u8820),
};

static struct snddev_icodec_data snddev_ispeaker_music_stereo_rx_data_u8820 = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "speaker_music_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_MUSIC_STEREO,// 241
	.profile = &ispeaker_music_stereo_rx_profile_u8820,
	.channel_mode = 2,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_ispeaker_music_stereo_rx_device_u8820 = {
	.name = "snddev_icodec",
	.id = 33,
	.dev = { .platform_data = &snddev_ispeaker_music_stereo_rx_data_u8820 },
...
static struct adie_codec_action_unit ifmradio_headset_osr64_actions[] =
	FM_HEADSET_CLASS_AB_STEREO_CAPLESS_OSR_64;//FM_HEADSET_STEREO_CLASS_D_LEGACY_OSR_64; 
...
/* set msm_snddev_poweramp_4music_on as pamp_on */
...
static struct adie_codec_action_unit ifm_analog_speaker_48KHz_osr256_actions_u8820[] =
	FM_ANALOG_SPEAKER_48000_OSR_256_U8820; 

static struct adie_codec_hwsetting_entry ifm_analog_speaker_settings_u8820[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ifm_analog_speaker_48KHz_osr256_actions_u8820,
		.action_sz = ARRAY_SIZE(ifm_analog_speaker_48KHz_osr256_actions_u8820),
	}
};

static struct adie_codec_dev_profile ifm_analog_speaker_profile_u8820 = {
	.path_type = ADIE_CODEC_RX,
	.settings = ifm_analog_speaker_settings_u8820,
	.setting_sz = ARRAY_SIZE(ifm_analog_speaker_settings_u8820),
};

static struct snddev_icodec_data snddev_analog_fm_speaker_data_u8820 = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "fmradio_analog_speaker",
	.copp_id = 0,
	.acdb_id = PSEUDO_ACDB_ID,
	.profile = &ifm_analog_speaker_profile_u8820,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device  msm_snddev_analog_fm_speaker_device_u8820 = {
	.name = "snddev_icodec",
	.id = 250,
	.dev = { .platform_data = &snddev_analog_fm_speaker_data_u8820},
};

static struct adie_codec_action_unit ifm_analog_hs_48KHz_osr256_actions_u8820[] =
	FM_ANALOG_HEADSET_48000_OSR_256_U8820;

static struct adie_codec_hwsetting_entry ifm_analog_hs_settings_u8820[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ifm_analog_hs_48KHz_osr256_actions_u8820,
		.action_sz = ARRAY_SIZE(ifm_analog_hs_48KHz_osr256_actions_u8820),
	}
};

static struct adie_codec_dev_profile ifm_analog_hs_profile_u8820 = {
	.path_type = ADIE_CODEC_RX,
	.settings = ifm_analog_hs_settings_u8820,
	.setting_sz = ARRAY_SIZE(ifm_analog_hs_settings_u8820),
};

static struct snddev_icodec_data snddev_analog_fm_hs_data_u8820 = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "fmradio_analog_headset",
	.copp_id = 0,
	.acdb_id = PSEUDO_ACDB_ID,
	.profile = &ifm_analog_hs_profile_u8820,
	.channel_mode = 2,
	.default_sample_rate = 48000,
	.pamp_on = msm_snddev_hsed_voltage_on,
	.pamp_off = msm_snddev_hsed_voltage_off,
...
static struct platform_device msm_snddev_analog_fm_hs_device_u8820 = {
	.name = "snddev_icodec",
	.id = 251,
	.dev = { .platform_data = &snddev_analog_fm_hs_data_u8820 },
};
...
static struct platform_device *snd_devices_u8820[] __initdata = {
	...
	&msm_snddev_analog_fm_speaker_device_u8820,
	&msm_snddev_analog_fm_hs_device_u8820,
    &msm_ispeaker_ptt_rx_device,
    &msm_ispeaker_ptt_tx_device,
    &msm_ihs_ptt_stereo_rx_device,
    &msm_ihs_mono_tx_device_ptt,
    &msm_idual_mic_broadside_ptt_device,
    &msm_iearpiece_music_device_u8820,
    &msm_iearpiece_ptt_device,
...
static struct platform_device *snd_devices_u8800_51_VER_D[] __initdata = {
	&msm_iearpiece_device_u8800_51_ver_d,
	&msm_imic_device_u8800_51,
	&msm_ihs_stereo_rx_device_u8800_51,
	&msm_ihs_mono_tx_device_u8800_51,
	&msm_bt_sco_earpiece_device_u8800_51,
    ...
    &msm_snddev_analog_fm_speaker_device,
    &msm_snddev_analog_fm_hs_device,
    &msm_iearpiece_hac_withGPIO_device,
};
...
void __init msm_snddev_init(void)
{
    ...
    {
        if (get_hw_sub_board_id() >= HW_VER_SUB_VD)
        {
            platform_add_devices(snd_devices_u8800_51_VER_D, ARRAY_SIZE(snd_devices_u8800_51_VER_D));
        }
        else {
