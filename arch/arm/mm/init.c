...
void show_mem(void)
{
	...
	for_each_online_node(node) {
		/* for 7x30 SPARSEMEM memory, not using map to calculate page */
		...
		for_each_nodebank (i,mi,node) {
			...
			/* 7x30 multiple sections for SPARSEMEM memory and uncontiguous, use pfn_to_page
			 * to calculate the start page and end page of a blank. 
			 * Not using map memory to calculate.
			*/
