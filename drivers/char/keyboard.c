...
/* patch: Input: implement sysrq as an input handler
*  delete #include <linux/sysrq.h>
*/
...
/* patch: Input: implement sysrq as an input handler
* delete EXPORT_SYMBOL_GPL(k_handler); and add static for k_handler_fn
*/
